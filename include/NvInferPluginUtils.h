...
//! yolo9000, generate 3 bounding boxes per cell). For each box, calculating its probablities of objects detections from
//! 80 pre-defined classifications (yolo9000 has 9418 pre-defined classifications, and these 9418 items are organized as
//! work-tree structure). RegionParameters defines a set of parameters for creating the Region plugin layer. \param num
//! Number of predicted bounding box for each grid cell. \param coords Number of coordinates for a bounding box. \param
//! classes Number of classfications to be predicted. \param softmaxTree When performing yolo9000, softmaxTree is
//! helping to do softmax on confidence scores, for element to get the precise classfication through word-tree
//! structured classfication definition. \deprecated. This plugin is superseded by createRegionPlugin()
//!
