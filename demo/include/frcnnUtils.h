...
struct UffFasterRcnnParams : public samplesCommon::SampleParams
{
...
//! input dimensions and different image preprocessing.
//!
class BatchStream {
public:
  BatchStream(int batchSize, int maxBatches, const std::string &prefix,
  ...
  BatchStream(int batchSize, int maxBatches, const nvinfer1::Dims &dims,
...
UffFasterRcnnParams initializeUffRCNNParams(const FrcnnArgs& args)
{
    UffFasterRcnnParams params;

    if (args.dataDirs.empty())
    {
        // Use default directories if user hasn't provided directory paths
        params.dataDirs.push_back("/home/liushuai/Inference/data");
        params.dataDirs.push_back("/home/liushuai/Inference/data");
    }
    else
    {
